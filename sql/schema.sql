...
CREATE TABLE `applications` (
  ...
  `response` enum('Nothing Yet','Positive Email/Call','Rejection Email/Call') DEFAULT 'Nothing Yet',
  `interview_stage` enum('None','Telephone','Skill Assessment','Face-to-Face','Declined') DEFAULT 'None',
